...
export const savedHostelCollectionId =
  Constants.expoConfig.extra.savedHostelCollectionId;
export const messagesCollectionId =
  Constants.expoConfig.extra.messagesCollectionId;
...
//Get all user
export async function getAllUsersExcludingCurrentUser(user) {
...
//delete user
export const deleteUserById = async (name,userId) => {
  try {
...
export async function searchUser(query) {
  try {
    const posts = await databases.listDocuments(databaseId, userCollectionId, [
